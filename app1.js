                ...
                userDetail.find({mobileNumber:req.body.mobileNumber},async function (err,results){
                    if (results && results.length>0){
                        ...
                        if(!err){
                            ...
                            var options ={authorization:"NsFO9GmgTW7xjdih6SXzbu8pDYC21ylrnw5MQfetvB3PcIHUREOnkjsPat0w7zTEmK8i91eI2gSMLQHx" , message : `${req.body.name}, This is the OTP of "Our Logistics. It's Confidential please do not share it. Your OTP: ${random_string} ` ,  numbers : [req.body.mobileNumber]} 
                            ...
                            app.get("/authenticate",redirectLoggedin,(req,res)=>{
                                ...
                                app.get("/resend-otp",async (req,res)=>{
                                    ...
                                    var options ={authorization:"NsFO9GmgTW7xjdih6SXzbu8pDYC21ylrnw5MQfetvB3PcIHUREOnkjsPat0w7zTEmK8i91eI2gSMLQHx" , message : `${userDetailObject.name}, This is the New OTP. It's Confidential please do not share it:  ${random_string} ` ,  numbers : [userDetailObject.mobileNumber]} 
                                    let response = await fast2sms.sendMessage(options) //Asynchronous Function.
                                    console.log(response)
                                    res.redirect("back") 
                                })
                            ...
                            app.post("/authenticate",redirectLoggedin,(req,res)=>{
                                ...
                                if(random_string==req.body.otp){
                                    userDetailObject.save(async function   (){
                                        var options ={authorization:"NsFO9GmgTW7xjdih6SXzbu8pDYC21ylrnw5MQfetvB3PcIHUREOnkjsPat0w7zTEmK8i91eI2gSMLQHx" , message : `You are the first User to get registered in "TGH Logistics". Thank You For Registering` ,  numbers : [req.session.mobileNumber]} 
                                        let response = await fast2sms.sendMessage(options) //Asynchronous Function.
                                        console.log(response);
            ...
            userDetail.find({mobileNumber:req.body.mobileNumber},async function (err,results){
                if (results && results.length>0){
                    ...
                    if(!err){
                        ...
                        random_string=makeid(6)
                        console.log(random_string)
                        var options ={authorization:"NsFO9GmgTW7xjdih6SXzbu8pDYC21ylrnw5MQfetvB3PcIHUREOnkjsPat0w7zTEmK8i91eI2gSMLQHx" , message : `${req.body.name}, This is the OTP of "Our Logistics. It's Confidential please do not share it OTP: ${random_string}` ,  numbers : [req.body.mobileNumber]} 
                        let response = await fast2sms.sendMessage(options) //Asynchronous Function.
                        console.log(response);
                        req.session.mobileNumber=req.body.mobileNumber;
                        const hashedPassword= await bcrypt.hash(req.body.password,12)
                        ...
                        app.get("/authenticate",redirectLoggedin,(req,res)=>{
                            ...
                            app.get("/resend-otp",async (req,res)=>{
                                ...
                                random_string=makeidForResend(6)
                                console.log(random_string + " resended")
                                var options ={authorization:"NsFO9GmgTW7xjdih6SXzbu8pDYC21ylrnw5MQfetvB3PcIHUREOnkjsPat0w7zTEmK8i91eI2gSMLQHx" , message : `${userDetailObject.name}, This is the New OTP. It's Confidential please do not share it. OTP:  ${random_string} `,  numbers : [userDetailObject.mobileNumber]} 
                                let response = await fast2sms.sendMessage(options) //Asynchronous Function.
                                console.log(response);
                                res.redirect("back") 
                            })
...
app.post("/forgetPassword",redirectLoggedin,async (req,res)=>{
    ...
    random_string=makeid(6)
    console.log(random_string)
    var options ={authorization:"NsFO9GmgTW7xjdih6SXzbu8pDYC21ylrnw5MQfetvB3PcIHUREOnkjsPat0w7zTEmK8i91eI2gSMLQHx" , message :`${req.body.name}, This is the otp for your forgotten password. It's Confidential please do not share it OTP: ${random_string} `,  numbers : [req.body.mobileNumber]} 
    let response = await fast2sms.sendMessage(options) //Asynchronous Function.
    console.log(response);
            ...
            app.get("/forgetPassword/OTPSent",redirectLoggedin,(req,res)=>{
                AllErrors=[]
                                ...
                                app.get("/resend-otp",async (req,res)=>{
                                    ...
                                    random_string=makeidForResend(6)
                                    console.log(random_string + " resended")
                                    var options ={authorization:"NsFO9GmgTW7xjdih6SXzbu8pDYC21ylrnw5MQfetvB3PcIHUREOnkjsPat0w7zTEmK8i91eI2gSMLQHx" , message :`${user.name}, This is the New OTP. It's Confidential please do not share it:  ${random_string} `,  numbers : [user.mobileNumber]} 
                                    let response = await fast2sms.sendMessage(options) //Asynchronous Function.
                                    console.log(response);
                    ...
                    bcrypt.compare(req.body.password,user.password,function(err,result){
                        ...
                        if(result){
                            ...
                            app.get("/passwordChanged",redirectLoggedin,async  (req,res)=>{
                                if(req.session.forgotPassword){
                                    var options ={authorization:"NsFO9GmgTW7xjdih6SXzbu8pDYC21ylrnw5MQfetvB3PcIHUREOnkjsPat0w7zTEmK8i91eI2gSMLQHx" , message :`${user.name}, Your Old Password has been changed.`,  numbers : [user.mobileNumber]} 
                                    let response = await fast2sms.sendMessage(options) //Asynchronous Function.
                                    console.log(response);
