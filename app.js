...
const uri = "mongodb+srv://admin:admin123@cluster0.w7spq.mongodb.net/myFirstDatabase?retryWrites=true&w=majority";
...
const myMongoStore = new MongoDBStore({
    uri: "mongodb+srv://admin:admin123@cluster0.w7spq.mongodb.net/myFirstDatabase?retryWrites=true&w=majority",
...
const{
    ...
    smsAuthorization="NsFO9GmgTW7xjdih6SXzbu8pDYC21ylrnw5MQfetvB3PcIHUREOnkjsPat0w7zTEmK8i91eI2gSMLQH"
} = process.env
...
app.post("/forgetPassword",redirectLoggedin,async (req,res)=>{
    ...
    random_string=makeid(6)
    console.log(random_string)
    var options ={authorization:smsAuthorization , message :`${req.body.name}, This is the otp for your forgotten password. It's Confidential please do not share it OTP: ${random_string} `,  numbers : [req.body.mobileNumber]} 
    let response = await fast2sms.sendMessage(options) //Asynchronous Function.
    console.log(response);
